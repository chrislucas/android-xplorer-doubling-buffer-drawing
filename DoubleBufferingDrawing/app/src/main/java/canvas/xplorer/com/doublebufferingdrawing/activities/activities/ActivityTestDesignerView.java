...
import canvas.xplorer.com.doublebufferingdrawing.activities.fragments.FragmentSingleTouchCanvasDesigner;
...
public class ActivityTestDesignerView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BaseFragment baseFragment = FragmentSingleTouchCanvasDesigner.newInstance();
